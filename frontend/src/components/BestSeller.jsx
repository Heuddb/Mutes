...
import Loader from "./Loader";
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center my-5 playfair-display">
        <h2 className="text-3xl inline-block relative pb-1.5 after:content-[''] after:absolute after:left-1/2 after:-bottom-1 after:-translate-x-1/2 after:w-28 after:h-[2px] after:bg-black">
          Best Seller
        </h2>
      </div>
